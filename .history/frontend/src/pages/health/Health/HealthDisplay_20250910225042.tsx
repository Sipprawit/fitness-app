...
function HealthDisplay({ health, onHealthUpdate }: Props) {
  const [isEditing, setIsEditing] = useState(false);
  const [editData, setEditData] = useState({
    weight: health?.weight || 0,
    height: health?.height || 0,
    body_fat: health?.body_fat || 0,
    muscle_mass: health?.muscle_mass || 0,
    note: health?.note || ""
  });

  const handleSave = () => {
    if (onHealthUpdate && health) {
      onHealthUpdate({
        ...health,
        ...editData
      });
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            borderRadius: "10px",
            border: "none",
            backgroundColor: isEditing ? "#6b7280" : "#c50000",
            color: "#fff",
            fontWeight: "600",
            cursor: "pointer",
            fontSize: "0.9rem",
          ...
          onMouseOver={(e) => e.currentTarget.style.backgroundColor = isEditing ? "#4b5563" : "#dc2626"}
          onMouseOut={(e) => e.currentTarget.style.backgroundColor = isEditing ? "#6b7280" : "#c50000"}
        >
        ...
        <div style={{
          ...
          {isEditing ? (
            <input
              ...
              onChange={(e) => setEditData({...editData, body_fat: parseFloat(e.target.value) || 0})}
              style={{
                width: "100%",
                padding: "0.5rem",
                borderRadius: "8px",
          ...
          <div style={{ flex: 1 }}>
            ...
            {isEditing ? (
              <input
                ...
                onChange={(e) => setEditData({...editData, muscle_mass: parseFloat(e.target.value) || 0})}
                style={{
                  width: "100%",
                  padding: "0.5rem",
                  borderRadius: "8px",
      ...
      <div style={{
        ...
        {isEditing ? (
          <textarea
            ...
            placeholder="เพิ่มหมายเหตุเกี่ยวกับสุขภาพของคุณ..."
          />
        ) : (
          <div style={{
            color: "#0c4a6e",
