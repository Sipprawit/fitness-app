      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            borderRadius: "10px",
            border: "none",
            backgroundColor: isAddingActivity ? "#6b7280" : "#f59e0b",
            color: "#fff",
            fontWeight: "600",
            cursor: "pointer",
            fontSize: "0.9rem",
          ...
          onMouseOver={(e) => e.currentTarget.style.backgroundColor = isAddingActivity ? "#4b5563" : "#d97706"}
          onMouseOut={(e) => e.currentTarget.style.backgroundColor = isAddingActivity ? "#6b7280" : "#f59e0b"}
        >
