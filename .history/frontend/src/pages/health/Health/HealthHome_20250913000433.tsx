...
export default function HealthHome() {
  ...
  const handleHealthUpdate = async (updatedHealth: HealthData) => {
    try {
      ...
      // รีเฟรชข้อมูลทั้งหมดเพื่อให้ allHealthData อัปเดต
  ...
  const handleActivityEdit = (_id: number, activity: Activity) => {
    ...
    <div style={pageStyle}>
      ...
      <div style={tabContainerStyle}>
        <button
          style={{
            ...tabButtonStyle,
            backgroundColor: activeTab === 'health' ? '#c50000' : 'rgba(255,255,255,0.6)',
            color: activeTab === 'health' ? '#fff' : '#374151'
          }}
        ...
        <button
          style={{
            ...tabButtonStyle,
            backgroundColor: activeTab === 'activity' ? '#c50000' : 'rgba(255,255,255,0.6)',
            color: activeTab === 'activity' ? '#fff' : '#374151'
          }}
        ...
        <button
          style={{
            ...tabButtonStyle,
            backgroundColor: activeTab === 'overview' ? '#c50000' : 'rgba(255,255,255,0.6)',
            color: activeTab === 'overview' ? '#fff' : '#374151'
          }}
        ...
        <button
          style={{
            ...tabButtonStyle,
            backgroundColor: activeTab === 'weekly' ? '#c50000' : 'rgba(255,255,255,0.6)',
            color: activeTab === 'weekly' ? '#fff' : '#374151'
          }}
          ...
          <div style={formsContainerStyle}>
            <HealthForm 
              ...
              initialData={editingHealthData ? {
                ...
                pressure: editingHealthData.pressure
              } : undefined}
...
const titleStyle: React.CSSProperties = {
  ...
  color: "#c50000",
  marginBottom: "2rem",
  textShadow: "0 4px 8px rgba(197,0,0,0.3)",
  fontWeight: "bold",
};
