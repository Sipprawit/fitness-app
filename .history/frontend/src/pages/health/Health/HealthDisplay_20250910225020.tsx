      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            borderRadius: "10px",
            border: "none",
            backgroundColor: isEditing ? "#6b7280" : "#0ea5e9",
            color: "#fff",
            fontWeight: "600",
            cursor: "pointer",
            fontSize: "0.9rem",
          ...
          onMouseOver={(e) => e.currentTarget.style.backgroundColor = isEditing ? "#4b5563" : "#0284c7"}
          onMouseOut={(e) => e.currentTarget.style.backgroundColor = isEditing ? "#6b7280" : "#0ea5e9"}
        >
