...
function HealthSummary({ health, activities, nutrition, selectedDate }: Props) {
  ...
  useEffect(() => {
    ...
    const totalActivityMinutes = activities.reduce((sum, activity) => sum + activity.duration, 0);
    const activityCount = activities.length;
    
    // คำนวณแคลอรี่ที่บริโภค (ถ้ามีข้อมูลโภชนาการ)
    let totalCaloriesConsumed = 0;
    if (nutrition && nutrition.meals) {
      totalCaloriesConsumed = nutrition.meals.reduce((sum, meal) => sum + (meal.calories || 0), 0);
    }
    ...
    setWeeklyData({
      ...
      averageWeight: health?.weight || 0,
      activityCount
    });
  }, [health, activities, nutrition]);
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ color: "#166534", fontWeight: "600" }}>{weeklyData.activityCount} ครั้ง</span>
            </div>
            ...
            <div style={{
              ...
              <span style={{ color: "#166534", fontWeight: "600" }}>{weeklyData.totalActivityMinutes} นาที</span>
            </div>
