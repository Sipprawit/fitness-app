...
export default function HealthHome() {
  const { health, activities: activitiesList, allHealthData, allActivities, nutrition, updateActivity, deleteActivity, setHealth } = useHealthActivity();
  ...
  const handleHealthUpdate = async (updatedHealth: HealthData) => {
    try {
      ...
      if (!response.ok) {
        ...
        alert("บันทึกข้อมูลสุขภาพไม่สำเร็จ: " + error.error);
        return;
      }
      ...
      alert("เกิดข้อผิดพลาดในการบันทึกข้อมูลสุขภาพ");
    }
  };
  ...
  return (
    <div style={pageStyle}>
      ...
      {/* Summary Section - Show for overview and weekly tabs */}
