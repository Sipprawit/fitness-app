  ...
  const handleSubmit = async () => {
    ...
    if (!goal.trim()) {
      showNotification({
        ...
        message: 'กรุณาระบุเป้าหมายโภชนาการของคุณ',
        duration: 2000
      });
      return;
    }
    ...
    try {
      ...
      showNotification({
        type: 'success',
        title: isEditing ? 'อัปเดตเป้าหมายโภชนาการสำเร็จ!' : 'บันทึกเป้าหมายโภชนาการสำเร็จ!',
        message: `เป้าหมาย: ${goal.trim()}${note.trim() ? `\nหมายเหตุ: ${note.trim()}` : ''}`,
        duration: 2000
      });
      ...
      showNotification({
        ...
        message: 'ไม่สามารถบันทึกเป้าหมายโภชนาการได้ กรุณาลองใหม่อีกครั้ง',
        duration: 5000
      });
    } finally {
      setSubmitting(false);
