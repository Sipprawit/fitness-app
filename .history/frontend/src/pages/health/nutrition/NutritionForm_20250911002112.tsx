...
interface Props {
  onSubmit: (data: { goal: string; total_calories_per_day: number; note?: string; protein_g?: number; fat_g?: number; carb_g?: number }) => void;
  currentGoal?: string;
  currentNote?: string;
...
function NutritionForm({ onSubmit, currentGoal, currentNote, currentProteinG, currentFatG, currentCarbG }: Props) {
  ...
  const [carbG, setCarbG] = useState(currentCarbG?.toString() || "");
