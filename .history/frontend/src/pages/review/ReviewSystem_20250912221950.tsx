    ...
    try {
      ...
      const formattedData: TrainingItem[] = await Promise.all(raw.map(async (booking: any) => {
        ...
        if (filter === 'คลาส') {
          ...
          console.log(`booking.Trainer:`, booking.Trainer);
          console.log(`booking.trainer_id:`, booking.trainer_id);
          console.log(`booking.trainerID:`, booking.trainerID);
          console.log(`booking.trainer_schedule_id:`, booking.trainer_schedule_id);
          console.log(`booking.trainerScheduleID:`, booking.trainerScheduleID);
          
          item = booking.trainer || booking.Trainer;
          
          // หา trainer_id จาก field ต่างๆ
          let trainerId = booking.trainer_id || booking.trainerID || booking.trainer_schedule_id || booking.trainerScheduleID;
