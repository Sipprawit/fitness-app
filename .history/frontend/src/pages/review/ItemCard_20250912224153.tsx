...
const ItemCard: React.FC<ItemCardProps> = ({ item, onReviewClick }) => {
  ...
  // Debug User data
  if (reviews[0] && reviews[0].User) {
    console.log(`User data:`, reviews[0].User);
    console.log(`User FirstName:`, reviews[0].User.FirstName);
    console.log(`User LastName:`, reviews[0].User.LastName);
    console.log(`User ProfileImage:`, reviews[0].User.ProfileImage);
  }
  ...
  console.log(`Latest two reviews:`, latestTwoReviews);
  console.log(`Latest two reviews length:`, latestTwoReviews.length);
      ...
      <div className="latest-reviews-section">
        ...
        {latestTwoReviews.length > 0 ? (
          latestTwoReviews.map((review: Review) => {
            ...
            return (
              <div key={review?.ID} className="review-entry" style={{ border: '1px solid red', padding: '10px', margin: '10px 0' }}>
