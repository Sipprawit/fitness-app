...
async function GetUserBookedClasses(userId: number) {
  try {
    return await axios.get(`${apiUrl}/api/class-bookings/user/${userId}/with-details`, authConfig());
  } catch (e: any) {
    return e.response;
  }
}
...
async function GetUserBookedTrainers(userId: number) {
  try {
    return await axios.get(`${apiUrl}/api/train-bookings/user/${userId}/with-details`, authConfig());
  } catch (e: any) {
    return e.response;
  }
}
